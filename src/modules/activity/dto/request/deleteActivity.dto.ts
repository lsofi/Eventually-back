...
export class DeleteActivityDto{
    @ApiProperty({
        ...
        required: true,
        description: 'Es el event_id del evento que contiene la actividad que se quiere eliminar.'
    })
    @IsNotEmpty({
    ...
    @ApiProperty({
        example: 'bb5dc8',
        required: true,
        description: 'Es el activity_id de la actividad que se quiere eliminar.'
    })
    @IsNotEmpty({
